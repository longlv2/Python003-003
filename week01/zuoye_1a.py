...
for url in urls_list:
    ...
    #获取上映时间
    plan_date = bs_info.find_all('li', attrs={'class': 'ellipsis'})[2].text[:10]
    print(plan_date)
#    for tags in bs_info.find_all('div', attrs={'class': 'movie-brief-container'}):
#        print(bs_info.find('h1').text)
#        for atag in tags.find_all('ul'):
#            print(atag.find('li', attrs={'class': 'ellipsis'}).text)
